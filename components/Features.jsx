...
const FEATURES = [
  ...
  { icon: '⚖️', title: 'Benefit-Risk Assessment', desc: "World's first AI-native BRAT benefit-risk evaluation engine. ICH E2C(R2)-aligned assessments from case data in under 50ms — a capability no legacy PV platform offers.", tag: 'First-in-Class · Sprint 82', bg: '#FFFBEB' },
